...
func (t Training) TrainingInfo() InfoMessage {
	// вставьте ваш код ниже
	infoMessageTraning := InfoMessage{
...
func (w Walking) Calories() float64 {
	...
	return ((CaloriesWeightMultiplier*w.Weight + (math.Pow(meanSpeed, 2)/Height)*CaloriesSpeedHeightMultiplier*w.Weight) * w.Duration.Hours() * MinInHours)
}
